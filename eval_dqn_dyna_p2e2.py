...
if __name__ == '__main__':
    ...
    model_dir = sys.path[0]+'/saved_models/dqn/dyna_p2e2/2020-04-08-00-20/pursuer/models'
    model_path = os.path.join(model_dir,'470000.h5')
