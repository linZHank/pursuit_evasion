...
from .purnav_scene0 import PursuerNavigationScene0


class PursuerNavigationScene0Discrete(PursuerNavigationScene0):

    def __init__(self, resolution=(80, 80)):
        super(PursuerNavigationScene0Discrete, self).__init__(resolution)
